...
DATASET_PATH = os.path.join(BASE_DIR, "Censys/data/processed/dataset_features_final_v3.csv")
OUTPUT_DIR = os.path.join(BASE_DIR, "Results/Results_dataset_v3")
os.makedirs(OUTPUT_DIR, exist_ok=True)

np.random.seed(42)

print("=" * 70)
print("PHISHING DETECTION - LOGISTIC REGRESSION PIPELINE (V3)")
print("=" * 70)
...
plt.title("ROC Curve - Phishing Detection (Dataset v3)", fontsize=14, fontweight="bold")
...
plt.title("Precision-Recall Curve - Phishing Detection (Dataset v3)", fontsize=14, fontweight="bold")
...
with open(summary_path, "w") as f:
    f.write("=" * 80 + "\n")
    f.write("FEATURE ANALYSIS SUMMARY - LOGISTIC REGRESSION (V3)\n")
